...
def jouer_une_partie(obtenir_coup_jaune: "Fonction(Plateau, Couleur) -> int", obtenir_coup_rouge: "Fonction(Plateau, Couleur) -> int") -> "PARTIE_NULLE|JAUNE_GAGNE|ROUGE_GAGNE":
    """ Fonction qui permet de jouer une partie de puissavnce 4 en donnant deux fonctions qui permettent 
